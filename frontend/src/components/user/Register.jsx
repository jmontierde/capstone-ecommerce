...
const Register = () => {
  ...
  return (
    <>
        ...
        <div className='flex justify-center items-center flex-col py-6  ' style={{ height: 'calc(100vh - 9.5rem)' }}>
            ...
            <div className='flex flex-col gap-2 px-16 py-6'>
                ...
                <div className='flex flex-col'>
                    <div>
                        ...
                        <img src={avatarPreview} className="rounded-circle w-32 h-32" alt="Avatar Preview"  />
