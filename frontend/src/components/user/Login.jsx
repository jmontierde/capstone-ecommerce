    ...
    return (
      <div className="container mx-auto ">
        <div className='flex justify-center items-center flex-col py-6 border-dotted border-[#d05e5e] border-4 ' style={{ height: 'calc(100vh - 9.5rem)' }}>
          <h1 className='font-bold text-xl'>Login</h1>
          <p className='w-96 text-center py-3'>In order to log in, please enter the email address you used to sign up.</p>
